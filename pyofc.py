...
class OfflineFileCache:
    ...
    def __init__(self, cachedir, cachetime, fetchfunction, fetcharg = False,
      verbose = False):
    ...
    def set(self, id, data):
        ...
        try:
            ...
            print("OfflineFileCache: Error opening file %s: %s" % (self.cachedir + id, e))
            #return False
